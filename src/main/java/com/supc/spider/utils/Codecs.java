...
public final class Codecs {
    ...
    private static HashFunction HF = Hashing.murmur3_128("supc".hashCode());
    ...
    public static String hash62(long l) {
        return Base62Encoder.encode(HF.hashLong(l).asLong());
    }

    public static String hash62(byte[] bytes) {
        return Base62Encoder.encode(HF.hashBytes(bytes).asLong());
    }
    ...
    public static byte[] toBytes(String s) {
        ...
        try {
            ...
            System.out.println("snowflake error");
            return null;
        }
    }
